...
async function liveMV(contatoOriginal, tipo ,time = 60, nomeCliente = ''){
    ...
    const mensagem = `🌻🍃🌼🍃🌺🍃🌸\n\n*Começa AGORA (às 19 horas) o MV Preview - Verão 22.*\n\n*Hoje (21) até o dia 24 serão realizadas Lives no Youtube da MV Tecidos, apresentando as tendências para o verão 2022.*\n\n*Dia 24, Live da Estamparia, será o lançamento das Estampas Exclusivas da MV Tecidos.*\n\n*Aproveite os conteúdos e dicas para vc arrasar na melhor estação do ano!!*😉\n\nLive de hoje acontecerá no link\n*https://www.youtube.com/watch?v=wvtAM1U0zTA*\n\nAcompanhe pelo site\n*https://mvtecidos.com.br/lives* \n\n*OBS*: Caso você não consiga clicar no link, é necessário que me mande uma mensagem para conseguir`
...
async function newsMV(contatoOriginal, tipo ,time = 60, nomeCliente = ''){
    ...
    nomeCliente = nomeCliente?.substring(0, nomeCliente?.indexOf(' '))
    let comprimento=`Boa noiteee ${nomeCliente} tudo bem? Marco Túlio da MV Tecidos aqui.`
    ...
    if(resp === true){
        ...
        switch (tipo) {
            case 'live':
                nome = 'live'
                mensagem = `🌻🍃🌼🍃🌺🍃🌸\n\n*AGORA é a Live da Estamparia Brisa, no youtube e instagram da MV Tecidos!!*\n\n*Serão apresentadas as Estampas Exclusicas da MV Tecidos e todas as tendências de estamparia para o Verão 22!!*\n\n*Aproveite os conteúdos e dicas para vc arrasar na melhor estação do ano!!*😉\n\n*Veja no vídeo os brindes que serão sorteados na LIVE!*\n\nhttps://instagram.com/mvtecidos/live/17926521580627266`
            break;
            case 'tiktok':
                nome = 'tiktok'
            ...
            case 'avisonewsletter':
                ...
                mensagem = `💥 CHEGAMOS! SUA NEWSLETTER DE MODA ESTÁ EM SEU EMAIL.\n\nA news de hoje foi bem completinha: tivemos indicação de eventos, projetos sociais, filme levinho de assistir e uma super dica de tendência de modelagem. Confiram o seu email!!\n\nLembrem-se de conferir a caixa de SPAM e adicionar a MV Tecidos na sua agenda! \n\nAinda não é cadastrado? Se inscreva gratuitamente!\n\nhttps://mvtecidos.com.br/newsletter/`
            break;
            case 'newsletter':
                nome = '5MINUTOSLEITURA'
